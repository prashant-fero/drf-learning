...
number_re = re.compile(r"%s%s%s" % (PREFIX_PATTERN, NUMBER_PATTERN, SUFFIX_PATTERN))
...
class NumberPattern(object):
    def __init__(
        self, pattern, prefix, suffix, grouping, int_prec, frac_prec, exp_prec, exp_plus
    ):
    ...
    def apply(
        ...
        retval = "".join([self.prefix[is_negative], number, self.suffix[is_negative]])
